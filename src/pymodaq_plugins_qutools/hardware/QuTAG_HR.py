...
#            os.environ['PATH'] += ':/home/bernhard/lab/qutag/lib'
            self.qutools_dll = ctypes.cdll.LoadLibrary('/home/bernhard/lab/qutag/lib/libtdcbase.so')
        else:
...
# Configure Channels ----------------------------------------------------------------
    ...
    def getChannelsEnabled(self):
        ...
        if ans != 0:
            print("Error in TDC_enableChannels: "+self.err_dict[ans])
        return channelStart.value == 1, enabledChannels # patch BL
